...
var vistedPages = [];
var pagesToVist = ["https://weston.co.in/branch-location/"];
...
async function scrape(currlink) {
    ...
    try {
        await page.waitForSelector('.branchLocationAddress ul li', { timeout: 1000 });
    ...
    let tbleCont = await page.evaluate(() => {
        ...
        let tableHeader = document.querySelectorAll('.branchLocationAddress ul li');
