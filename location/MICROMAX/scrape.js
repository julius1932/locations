...
var vistedPages = [];
var pagesToVist = ["http://www.micromaxinfo.com/store-locator"];
...
async function scrape(currlink) {
    ...
    try {
        await page.waitForSelector('.storeListContent', { timeout: 1000 });
    ...
    let tbleCont = await page.evaluate(() => {
        ...
        let tableHeader = document.querySelectorAll('.storeListContent');
