...
var vistedPages = [];
var pagesToVist = ["https://pittappillilonline.com/BranchLocator.aspx"];
...
async function scrape(currlink) {
    ...
    try {
        await page.waitForSelector('.branch_list_main', { timeout: 1000 });
    ...
    let tbleCont = await page.evaluate(() => {
        ...
        let tableHeader = document.querySelectorAll('.branch_list_main');
