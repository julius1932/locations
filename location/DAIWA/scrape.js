...
var vistedPages = [];
var pagesToVist = ["https://www.daiwa.in/dealers/"];
...
async function scrape(currlink) {
    ...
    await page.waitForSelector('ul#locationList li .f-l');
    ...
    let tbleCont = await page.evaluate(() => {
        ...
        let tableHeader = document.querySelectorAll('ul#locationList li');
