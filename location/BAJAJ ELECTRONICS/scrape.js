...
var vistedPages = [];
var pagesToVist = ["https://www.bajajelectronics.com/stores"];
...
async function scrape(currlink) {
    ...
    try {
        await page.waitForSelector('div.address div.pos', { timeout: 1000 });
    ...
    let tbleCont = await page.evaluate(() => {
        ...
        let tableHeader = document.querySelectorAll('div.address div.pos');
