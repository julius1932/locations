...
var vistedPages = [];
var pagesToVist = ["http://www.raipurelectronics.com/showrooms.html"];
...
async function scrape(currlink) {
    ...
    await page.waitForSelector('table tbody tr td .paragraph');
    ...
    let tbleCont = await page.evaluate(() => {
        ...
        let tableHeader = document.querySelectorAll('table tbody tr td .paragraph');
