...
var vistedPages = [];
var pagesToVist = ["https://www.digi1electronics.com/digi1-stores"];
...
async function scrape(currlink) {
    ...
    await page.waitForSelector('.container-fluid.digi1-stores div div div.card');
    let tbleCont = await page.evaluate(() => {
        var arr = [];
        let tableHeader = document.querySelectorAll('.container-fluid.digi1-stores div div div.card');
        if (tableHeader) {
