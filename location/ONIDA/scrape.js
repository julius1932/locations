...
var vistedPages = [];
var pagesToVist = ["https://www.onida.com/stores"];
...
async function scrape(currlink) {
    ...
    try {
        await page.waitForSelector('.locator-box', { timeout: 1000 });
    ...
    let tbleCont = await page.evaluate(() => {
        ...
        let tableHeader = document.querySelectorAll('.locator-box');
